...
// export class RecieverTest extends TypedEmitter<TransferEvents> {
...
//   private fileWriters: FileSystemWritableFileStream[] | null;
...
//             if (candidates) {
//                 this.emit("recieverCandidates", { value: JSON.stringify(candidates) });
//             } else {
...
//       const offset = chunk.chunkId * RecieverTest.CHUNK_SIZE;
