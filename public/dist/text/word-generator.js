...
var Sentences;
(function (Sentences) {
    Sentences[Sentences["Short"] = 0] = "Short";
    Sentences[Sentences["Medium"] = 1] = "Medium";
    Sentences[Sentences["Long"] = 2] = "Long";
})(Sentences || (Sentences = {}));
...
function pickEndPuncuation(lang = "eng") {
...
export function formSentence(wordsLen = 0, lang = "eng") {
    const wordList = [];
    if (wordsLen <= 0) {
    ...
    while (wordsLen > 0) {
        ...
        if (!choosenWord)
            continue;
        if (wordList.slice(-getRand(2, 4)).includes(choosenWord))
            continue;
...
export function formNSentences(sentenceCount, lang = "eng") {
    const sentenceList = [];
...
function pickParagraph(lang = "eng") {
...
export function formParagraphs(paragraphCount, lang = "eng") {
    const paragraphList = [];
